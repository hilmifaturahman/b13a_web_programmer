■ Front end Develover adalah orang yang membuat design dan mengembangkannya sampai sebuah website dapat berjalan.
______________________________________________________
■ Tugas Front End Developer:
  ■ Mengembangkan User Interface;
  ■ Mengembangkan atau membuat kode yang dapat digunakan untuk jangka panjang;
  ■ Memastikan kelayakan design UI/UX secara teknis;
  ■ Memastikan bahwa semua input pengguna divalidasi terlebih dahulu sebelum dikirim ke back end;
  ■ Membantu back end Developers dengan koding dan troubleshooting.
______________________________________________________
■ Keterampilan utama front end Developer:
  ■ Aktif belajar
  ...
  ■ Pemrograman
    Menulis program komputer sebagai tujuan.
  ■ Analis sistem
...
■ Keterampilan Back-end developer:
  ...
  ■ Evaluasi sistem
    Mengidentifikasi langkah atau indikator kinerja sistem dan tindakan yang dibutuhkan untuk mengembangkan atau memperbaiki kinerja, relatif terhadap tujuan sistem.
______________________________________________________
■ Main Data Provided: https://landingpageswnpg01.herokuapp.com/
______________________________________________________
■ Structured Landing Pages Implementation:
  ■ /css/style.css
  ■ /images/image.jpg
  ■ /js/script.js
  ■ /index.html
...
■ Panduan instalasi vscode (visual studio code) pada OS windows:
  ...
  ■ Pilih “I accept the aggrement” untuk menyetujui “License Agreement”, kemudian klik Next.
  ■ Untuk Select Destination Location bisa di biarkan saja jika lokasi instalasi tidak akan dirubah. Klik Next.
  ■ Klik Next lagi jika tidak ingin menambah ke Start Menu Folder
...
<body>
    <h3>Hello Test Web</h3>
</body>
</html>
______________________________________________________
■ Tugas sesi 1:
  ■ Screenshot instalasi vscode
  ■ Screenshot instalasi extension
  ■ Screenshot hasil koding
  ■ File HTML (File hasil koding)
______________________________________________________
■ Struktur folder:
  ■ Web Programmer - B13A/
    ■ Sesi-01/
    ...
    ■ belajar_web/
      ...
      ■ index_test.html
    ■ Sesi-02/
      ■ readme.txt > mencatat pembelajaran di sesi 02
      ■ belajar_web/
    ■ Sesi-03/
    ■ Sesi-04/
    ■ Sesi-05/
